...
const ReadComicsOnline_1 = require("../ReadComicsOnline/ReadComicsOnline");
describe('ReadComicsOnline Tests', function () {
    var wrapper = new paperback_extensions_common_1.APIWrapper();
    var source = new ReadComicsOnline_1.ReadComicsOnline(cheerio_1.default);
    ...
    it("Testing Home-Page aquisition", () => __awaiter(this, void 0, void 0, function* () {
        ...
        for (let obj of homePages[0].items) {
            ...
            let imageResult = yield axios.get(obj.image);
